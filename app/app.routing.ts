...
export type RouteTree = { section: string,name:string, routes: Routes }[];
...
export const routeTree: RouteTree = [
    {
        ...
        name:"权限管理",
        routes: [
            { path: '', redirectTo: 'right/user', pathMatch: 'full' },
            {
                path: 'right/user', data: { caption: '用户管理' },
                component: UserListComponent
            },
            {
              path: 'infra/globalization', data: { caption: '企业管理' },

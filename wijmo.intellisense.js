...
/// @see:mask value set; all other data types are required.</summary>
/// <returns type="Boolean"></returns>
}
...
/// <field name="meanMarkerStyle" type="Object">Gets or sets a value that determines whether the given data is relative.</field>
...
/// <field name="queryLoadingData" type="wijmo.Event">Occurs when quering the request data sent to the service before loading the document.</field>
